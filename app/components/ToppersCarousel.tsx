...
const ToppersCarousel = () => {
  const [currentIndex, setCurrentIndex] = useState(0);
  const [isAutoPlaying, setIsAutoPlaying] = useState(true);

  const images = [
    {
      src: '/images/Toppers/1000073503.jpg',
      alt: 'Topper - Estilo 1'
    },
    {
      src: '/images/Toppers/1000073504.jpg',
      alt: 'Topper - Estilo 2'
    },
    {
      src: '/images/Toppers/1000073506.jpg',
      alt: 'Topper - Estilo 3'
    },
    {
      src: '/images/Toppers/1000073507.jpg',
      alt: 'Topper - Estilo 4'
    },
    {
